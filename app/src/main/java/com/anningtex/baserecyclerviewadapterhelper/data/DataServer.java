package com.anningtex.baserecyclerviewadapterhelper.data;
...
public class DataServer {
    ...
    public static List<StatusEntity> getSampleData(int lenth) {
    ...
    public static List<StatusEntity> addData(List list, int dataSize) {
...
//    }
    ...
    public static List<MySectionEntity> getSectionData() {
        List<MySectionEntity> list = new ArrayList<>();
        for (int i = 0; i < 8; i++) {
            list.add(new MySectionEntity(true, "Section " + i));
            list.add(new MySectionEntity(false, new VideoEntity(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
            list.add(new MySectionEntity(false, new VideoEntity(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
            list.add(new MySectionEntity(false, new VideoEntity(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
            list.add(new MySectionEntity(false, new VideoEntity(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
            list.add(new MySectionEntity(false, new VideoEntity(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));

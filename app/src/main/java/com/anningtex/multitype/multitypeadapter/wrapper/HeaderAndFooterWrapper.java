package com.anningtex.multitype.multitypeadapter.wrapper;
...
import static com.anningtex.multitype.multitypeadapter.utils.WrapperUtils.setFullSpan;
...
public class HeaderAndFooterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (mInnerAdapter instanceof ICoustomAdapter) {
            ((ICoustomAdapter) mInnerAdapter).onViewAttachedToWindow(holder, position);
            return;
        }

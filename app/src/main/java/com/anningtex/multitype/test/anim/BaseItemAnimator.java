...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(RecyclerView.ViewHolder oldHolder,
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        mRemoveAnimations.add((ViewHolder) holder);
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            final ViewPropertyAnimatorCompat oldViewAnim = ViewCompat.animate(view).setDuration(
                    getChangeDuration());
            mChangeAnimations.add((ViewHolder) changeInfo.oldHolder);
        ...
        if (newView != null) {
            ...
            mChangeAnimations.add((ViewHolder) changeInfo.newHolder);
    ...
    private void endChangeAnimationIfNecessary(ChangeInfo changeInfo) {
        if (changeInfo.oldHolder != null) {
            endChangeAnimationIfNecessary(changeInfo, (ViewHolder) changeInfo.oldHolder);
        }
        if (changeInfo.newHolder != null) {
            endChangeAnimationIfNecessary(changeInfo, (ViewHolder) changeInfo.newHolder);
        }
    }
...
//        view.animate().setInterpolator(mDefaultInterpolator);
    ...
    public boolean animateRemove(RecyclerView.ViewHolder holder) {
        ...
        mPendingRemovals.add((ViewHolder) holder);
        return false;
    }
    ...
    public boolean animateAdd(RecyclerView.ViewHolder holder) {
        ...
        mPendingAdditions.add((ViewHolder) holder);
        return true;
    }
    ...
    public boolean animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        mPendingMoves.add(new MoveInfo((ViewHolder) holder, fromX, fromY, toX, toY));
        return true;
    }
    ...
    public void endAnimation(@NonNull RecyclerView.ViewHolder item) {
        ...
        endChangeAnimation(mPendingChanges, (ViewHolder) item);
        ...
        for (int i = mChangesList.size() - 1; i >= 0; i--) {
            ArrayList<ChangeInfo> changes = mChangesList.get(i);
            endChangeAnimation(changes, (ViewHolder) item);
            if (changes.isEmpty()) {
